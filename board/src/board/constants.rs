...
pub const FILE_A_OCCUPANCY: OccupancyBits = A1_MASK | A2_MASK | A3_MASK | A4_MASK | A5_MASK | A6_MASK | A7_MASK | A8_MASK;
pub const FILE_B_OCCUPANCY: OccupancyBits = B1_MASK | B2_MASK | B3_MASK | B4_MASK | B5_MASK | B6_MASK | B7_MASK | B8_MASK;
pub const FILE_C_OCCUPANCY: OccupancyBits = C1_MASK | C2_MASK | C3_MASK | C4_MASK | C5_MASK | C6_MASK | C7_MASK | C8_MASK;
pub const FILE_D_OCCUPANCY: OccupancyBits = D1_MASK | D2_MASK | D3_MASK | D4_MASK | D5_MASK | D6_MASK | D7_MASK | D8_MASK;
pub const FILE_E_OCCUPANCY: OccupancyBits = E1_MASK | E2_MASK | E3_MASK | E4_MASK | E5_MASK | E6_MASK | E7_MASK | E8_MASK;
pub const FILE_F_OCCUPANCY: OccupancyBits = F1_MASK | F2_MASK | F3_MASK | F4_MASK | F5_MASK | F6_MASK | F7_MASK | F8_MASK;
pub const FILE_G_OCCUPANCY: OccupancyBits = G1_MASK | G2_MASK | G3_MASK | G4_MASK | G5_MASK | G6_MASK | G7_MASK | G8_MASK;
pub const FILE_H_OCCUPANCY: OccupancyBits = H1_MASK | H2_MASK | H3_MASK | H4_MASK | H5_MASK | H6_MASK | H7_MASK | H8_MASK;
